    ...
    (
        ...
        return (
            ...
            >
                <div
                    className={cn(
                        "min-h-10 rounded-md border border-neutral-700 bg-neutral-800 text-sm ring-offset-sky-500 focus-within:ring-1 focus-within:ring-ring focus-within:ring-offset-1",
                        {
                        ...
                        {selected.map((option) => {
                            return (
                                <Badge
                                    ...
                                    className={cn(
                                        "text-sm font-normal",
                                        "data-[disabled]:bg-secondary data-[disabled]:text-muted data-[disabled]:hover:bg-secondary",
                                        "data-[fixed]:bg-secondary data-[fixed]:text-muted data-[fixed]:hover:bg-secondary",
                                        badgeClassName,
                                    )}
                                ...
                                >
                                    ...
                                    >
                                        <X className="h-3 w-3 text-secondary hover:text-primary" />
                                    </button>
                                </Badge>
                            );
                        })}
                ...
                <div className="relative">
                    {open && (
                        <CommandList
                            className="absolute top-1 z-10 w-full rounded-md border border-neutral-700 bg-neutral-800 text-secondary shadow-md outline-none animate-in"
                            onMouseLeave={() => {
