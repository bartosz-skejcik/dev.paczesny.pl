...
description: The story of a fight with Proxmox that ends with an epic plot twist. Setting up Immich in LXC, debugging the network, killing disks, and hours spent on iptables - all to discover that the phone had the container's IP occupied the whole time.
