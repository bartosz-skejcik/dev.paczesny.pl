...
description: "Zbuduję w moim homelabie Proxmox z macvlan, konfiguruje DDNS w Cloudflare i instaluję OpenVPN, by łatwo zarządzać VPN i domeną – zobacz, jak to zrobić krok po kroku."
...
No i klasa. Spojrzałem w rekordy DNS na cloudflarze i rekord A został zmieniony na moje _aktualne_ publiczne ip :D
