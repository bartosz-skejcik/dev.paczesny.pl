...
Temat jest głębszy (własne definicje subagentów, ograniczanie im narzędzi, tańsze modele do prostych zadań), ale to materiał na osobny wpis, więc na razie odsyłam do [dokumentacji subagentów](https://code.claude.com/docs/en/sub-agents).
...
Na start tak, zresztą właśnie od niego warto zacząć, bo załatwia większość przypadków za darmo. Ale CLAUDE.md to nadal prośba do modelu. Zasady, których złamanie realnie kosztuje (deploye, sekrety, cudze projekty), lepiej domknąć hookiem, bo hooka nie da się zignorować.
