...
Comme d'habitude, si je ne dis pas quelque chose, c'est que je m'apprends encore, désolé. Au moins, je présenterai l'idée générale. Si tu aimes ce genre de choses, tu peux jeter un œil à mon article sur [l'installation de Vaultwarden](/blog/fr/how-to-setup-vaultwarden-on-linux), c'est une histoire similaire, mais avec un gestionnaire de mots de passe.
...
> Si tu préfères faire le reverse proxy à la main avec Nginx et certbot (par exemple sur Proxmox), c'est exactement ce que j'ai montré dans [la deuxième partie de la série sur Proxmox](/blog/fr/proxmox-czesc-druga#préparation-de-lxc-sur-proxmox). Ici, Coolify/Traefik s'en charge pour moi.
...
Et maintenant, ma partie préférée. J'ai déjà toute [l'observabilité mise en place sur Oracle](/blog/fr/proxmox-czesc-druga) (Grafana + Prometheus + Loki), donc c'est dommage de ne pas l'utiliser.
