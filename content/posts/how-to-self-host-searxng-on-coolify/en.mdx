...
> If you prefer to set up a reverse proxy manually with Nginx and certbot (e.g., on Proxmox), I showed how to do that in [part two of my Proxmox series](/blog/en/proxmox-part-two#preparing-lxc-on-proxmox). Here, Coolify/Traefik handles it for me.
...
And my favorite part! I already have [observability set up on Oracle](/blog/en/proxmox-part-two) (Grafana + Prometheus + Loki), so it's a shame not to use it.
